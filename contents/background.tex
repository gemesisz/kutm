...
AI anti-cheat systems also utilize deep learning to detect boosting, where players artificially inflate their rank. For instance, FACEIT, an online competitive gaming platform, uses machine learning to track suspicious ranking progressions and automatically flag accounts for review \cite{FACEIT_anti_cheat}. 
